...
flaticron uses [bsd-mailx(1)](https://manpages.debian.org/testing/bsd-mailx/bsd-mailx.1.en.html) and assumes you have setup an MTA such as exim4 or postfix to send mail. The recommended setup is a satellite system with an external smarthost as mail relay.
